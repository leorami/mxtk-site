...
export const PRESETS_V2: Record<'learn' | 'build' | 'operate', PresetItem[]> = {
  learn: [
    // Overview
    { section: 'overview', type: 'whats-next',       title: "What's Next",     size: { w: 4, h: 20 }, pos: { x: 0, y: 0 } },
    { section: 'overview', type: 'recent-answers',   title: 'Recent Answers',   size: { w: 4, h: 20 }, pos: { x: 4, y: 0 } },
    { section: 'overview', type: 'note',             title: 'Note',             size: { w: 4, h: 20 }, pos: { x: 8, y: 0 }, data: { note: '' } },
    { section: 'overview', type: 'pools-mini',       title: 'Top Pools',        size: { w: 6, h: 18 }, pos: { x: 0, y: 20 }, data: { token: (process.env.MXTK_TOKEN_ADDRESS || '0x3e4Ffeb394B371AAaa0998488046Ca19d870d9Ba') } },
    { section: 'overview', type: 'price-mini',       title: 'Gold (XAU) Price', size: { w: 6, h: 18 }, pos: { x: 6, y: 20 }, data: { symbol: 'XAU', days: 7 as any } },
    // Learn
  ...
  operate: [
    ...
    { section: 'overview', type: 'note',             title: 'Note',             size: { w: 4, h: 20 }, pos: { x: 8, y: 0 }, data: { note: '' } },
    { section: 'overview', type: 'pools-mini',       title: 'Top Pools',        size: { w: 6, h: 18 }, pos: { x: 0, y: 20 }, data: { token: (process.env.MXTK_TOKEN_ADDRESS || '0x3e4Ffeb394B371AAaa0998488046Ca19d870d9Ba') } },
    { section: 'overview', type: 'price-mini',       title: 'Gold (XAU) Price', size: { w: 6, h: 18 }, pos: { x: 6, y: 20 }, data: { symbol: 'XAU', days: 30 as any } },
    // Operate
