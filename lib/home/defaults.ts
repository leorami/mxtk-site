...
import { Mode, SectionKey, SectionState, WidgetState } from './types';
...
export function seedWidgets(mode: Mode): WidgetState[] {
  const base: WidgetState[] = [
    ...
    { id:'w_note',    type:'note',               title:'Notes',               sectionId:'sec_train',    size:{w:4,h:6}, pos:{x:0,y:0} },
    { id:'w_next',    type:'whats-next',         title:"What's Next",         sectionId:'sec_train',    size:{w:4,h:6}, pos:{x:4,y:0} },
  ];
