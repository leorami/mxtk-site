...
export default function FooterDock(){
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-screen-sm px-[var(--gutter-sm)]">
        <div className="rounded-2xl bg-[color-mix(in_oKLCH,canvas,transparent_40%)] backdrop-blur-md shadow-lg border border-white/10 px-4 py-2 flex items-center justify-between">
